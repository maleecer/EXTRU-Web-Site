      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col items-center gap-6 mb-8">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-primary/70 mt-1">Faculty of Technology, RUSL</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-2 text-foreground/70 text-sm">
              ...
              <li><a href="#merchandise" className="hover:text-primary transition-colors duration-300">Merchandise</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-foreground/70 text-sm">
              <li className="flex items-center justify-center md:justify-start gap-2">
                ...
                <span>info@extru2026.lk</span>
              </li>
              <li className="flex items-center justify-center md:justify-start gap-2">
                <span className="text-accent">📞</span>
                <span>+94 25 226 1000</span>
              </li>
              <li className="flex items-center justify-center md:justify-start gap-2">
                <span className="text-accent">📍</span>
                <span>Technology Faculty Premises</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4 justify-center md:justify-start">
              <a href="#" className="text-primary hover:text-accent transition-all duration-300 hover:scale-110" aria-label="Facebook">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="#" className="text-primary hover:text-accent transition-all duration-300 hover:scale-110" aria-label="Instagram">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="text-primary hover:text-accent transition-all duration-300 hover:scale-110" aria-label="LinkedIn">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
